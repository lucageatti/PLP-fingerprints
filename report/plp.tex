...
\todo{Add references (also in the following)}
\cite{}.
%
...
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{The skeleton and the minutiae of a fingerprint.}
  \label{fig:skemin}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.75\linewidth]{img/skemingraph}
  \captionof{figure}{The ideal graph of the fingerprint in \cref{fig:skemin}}
...
\todo{Show the vertical line in the image.} 
...
\todo{Add something to the denote the third quartile in the image} line between
